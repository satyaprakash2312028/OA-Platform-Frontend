...
import { CheckCircle, FileText, ChevronLeft, ChevronRight, Check, ChevronRightIcon, ChevronLeftIcon } from 'lucide-react'
    ...
    >
      <ul className="list bg-base-200 rounded-box shadow-md font-mono">
        ...
        >
          ...
          <span className="p-4 pb-2 opacity-60 tracking-wide">Problemset</span>
